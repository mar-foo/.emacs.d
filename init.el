...
(custom-set-variables
 ...
 '(package-selected-packages
   '(haskell-mode vertico 'vertico 'vertico 'vertico 'vertico 'vertico acme-theme org-roam olivetti notmuch modus-vivendi-theme go-complete go-mode page-break-lines dante hindent vterm visual-fill-column use-package smartparens rainbow-delimiters projectile prescient org-fragtog org-bullets orderless marginalia magit hydra helpful gruvbox-theme general evil-collection eshell-git-prompt emojify corfu all-the-icons))
 '(rustic-ansi-faces
