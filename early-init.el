...
(custom-set-variables
 ...
 '(package-selected-packages
   '(mini-frame ob-cpp org-tree-slide dired-filter go-complete gcmh all-the-icons ob-go monochrome-theme vertico password-store exwm haskell-mode org-roam go-mode hindent prescient magit))
 '(rustic-ansi-faces
