...
(custom-theme-set-faces 'mf
   ...
   '(mode-line ((t (:box (:line-width -1 :style flat-button)
			      :background "#e0e0e0" :foreground "#303030"))))
   ...
   '(font-lock-variable-name-face ((t (:weight bold :foreground "#b3b3b3"))))
   ...
   ;; Flyspell
   '(flyspell-duplicate ((t (:weight unspecified :foreground unspecified :slant unspecified :underline "#303030"))))
   '(flyspell-incorrect ((t (:weight unspecified :foreground unspecified :slant unspecified :underline "#303030")))))
