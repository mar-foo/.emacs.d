...
(custom-theme-set-faces 'mf-dark
			...
			`(highlight ((t (:foreground "black" :background ,mf-default-fg))))
			...
			`(secondary-selection ((t (:foreground: ,mf-default-fg :background ,mf-dark-grey))))
			...
			`(company-tooltip-selection ((t (:foreground ,mf-default-fg :background ,mf-medium-grey))))

			;; Corfu
			`(corfu-current ((t (:foreground ,mf-default-fg :background "#b3b3b3"))))
			...
			`(warning ((t (:foreground ,mf-default-fg :background ,mf-default-bg :inherit font-lock-warning-face))))
			...
			;; helm
			`(helm-header ((t (:foreground "#bababa" :background ,mf-default-bg :underline nil :box nil))))
			'(helm-source-header
			  ((t (:foreground "#bababa"
					   :underline nil
					   :weight bold
			...
			`(helm-visible-mark ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-candidate-number ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-separator ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-time-zone-current ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-time-zone-home ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-bookmark-addressbook ((t (:foreground "#bababa" :background ,mf-default-bg))))
			'(helm-bookmark-directory ((t (:foreground nil :background nil :inherit helm-ff-directory))))
			'(helm-bookmark-file ((t (:foreground nil :background nil :inherit helm-ff-file))))
			`(helm-bookmark-gnus ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-bookmark-info ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-bookmark-man ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-bookmark-w3m ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-buffer-not-saved ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-buffer-process ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-buffer-saved-out ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-buffer-size ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-ff-directory ((t (:foreground "#bababa" :background ,mf-default-bg :weight bold))))
			`(helm-ff-file ((t (:foreground "#bababa" :background ,mf-default-bg :weight normal))))
			`(helm-ff-executable ((t (:foreground "#bababa" :background ,mf-default-bg :weight normal))))
			`(helm-ff-invalid-symlink ((t (:foreground "black" :background ,mf-default-bg :weight bold))))
			`(helm-ff-symlink ((t (:foreground "#bababa" :background ,mf-default-bg :weight bold))))
			`(helm-ff-prefix ((t (:foreground "#bababa" :background ,mf-default-bg :weight normal))))
			`(helm-grep-cmd-line ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-grep-file ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-grep-finish ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-grep-lineno ((t (:foreground "#bababa" :background ,mf-default-bg))))
			'(helm-grep-match ((t (:foreground nil :background nil :inherit helm-match))))
			`(helm-grep-running ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-moccur-buffer ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-mu-contacts-address-face ((t (:foreground "#bababa" :background ,mf-default-bg))))
			`(helm-mu-contacts-name-face ((t (:foreground "#bababa" :background ,mf-default-bg))))
			...
			`(completions-first-difference ((t (:underline ,mf-default-fg :weight semi-bold))))

			;; Mode line faces
			`(mode-line ((t (:background ,mf-default-bg :foreground ,mf-default-fg
						     :box (:line-width 4 :color ,mf-default-bg :style flat-button)))))
			`(mode-line-inactive ((t (:background ,mf-default-bg :foreground ,mf-medium-grey
							      :box (:line-width 4 :color ,mf-default-bg)))))

			;; Mini- modeline
			`(mini-modeline-mode-line ((t (:height 0.14 :background ,mf-default-fg))))
			...
			`(notmuch-tag-added ((t (:underline ,mf-default-fg))))
			...
			;; Orderless
			`(orderless-match-face-0 ((t (:foreground ,mf-default-fg :underline t  :weight bold))))
			...
			`(org-agenda-dimmed-todo-face ((t (:foreground ,mf-default-fg))))
			`(org-block ((t (:inherit shadow :extend t :background ,mf-default-bg))))
			...
			`(whitespace-line ((t (:background "#b3b3b3" :foreground ,mf-default-fg))))
