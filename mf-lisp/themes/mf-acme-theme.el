...
(let ((background "#FFFFEA")
  ...
  (custom-theme-set-faces
   ...
   `(org-level-2 ((t :bold t :height 1.2)))
   ...
   `(message-header-other ((t :weight bold)))
   `(message-header-to ((t nil)))
   `(message-header-subject ((t nil)))
   `(message-cited-text-1 ((t :weight bold)))
   `(message-cited-text-2 ((t :weight bold)))
   `(message-cited-text-3 ((t :weight bold)))
   `(message-cited-text-4 ((t :weight bold)))
