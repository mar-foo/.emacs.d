...
(define-key global-map (kbd "C-. '") #'jump-to-register)
...
(define-key global-map (kbd "C-. j") #'bookmark-jump)
(define-key global-map (kbd "C-. k") #'kill-current-buffer)
...
(define-key global-map (kbd "C-. s") #'query-replace-regexp)
