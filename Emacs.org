...
(require 'mf-eww)
   #+end_src
   #+begin_src emacs-lisp :tangle (concat user-emacs-directory "mf-lisp/mf-exww.el")
	 (eval-after-load 'eww
...
*** Sxrc
	...
	#+begin_src shell :tangle (cond ((string= mf/os "Linux\n") (file-truename "~/.config/sx/sxrc")) ((string= mf/os "OpenBSD\n") (file-truename "~/.xsession"))) :tangle-mode (if (eq exwm-state 1) (identity #o755) (identity #o664))
	  #!/bin/sh
	  pgrep mpd || mpd &
	  setxkbmap dvorak
	  xmodmap ~/.Xmodmap
