...
#+begin_src emacs-lisp :tangle (concat user-emacs-directory "mf-lisp/mf-mpc.el")
  ...
  (eval-after-load 'mpc
	'(progn
	   ...
	   (add-hook 'mpc-mode-hook #'(lambda () (setq header-line-format nil)))
...
#+begin_src emacs-lisp :tangle (concat user-emacs-directory "mf-lisp/mf-functions.el")
  ...
  (defun mf/lcm ()
	(interactive)
	(password-store-copy "lcm")
	(start-process-shell-command "st" nil "st -e ssh marioforzanini@lcm.mi.infn.it"))
